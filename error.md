...
To ensure your native dependencies are always matched electron version, simply add script `"postinstall": "electron-builder install-app-deps" to your `package.json`
  ...
  ⨯ cannot execute  cause=exit status 1
    ...
    npm error gyp info using node-gyp@10.1.0
    npm error gyp info using node@20.19.5 | win32 | x64
    npm error gyp info find Python using Python version 3.14.0 found at "C:\hostedtoolcache\windows\Python\3.14.0\x64\python.exe"
    ...
    npm error gyp info spawn C:\hostedtoolcache\windows\Python\3.14.0\x64\python.exe
